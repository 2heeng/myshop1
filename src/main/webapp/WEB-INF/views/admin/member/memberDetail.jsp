...
//	init();
    ...
    <script>
        ...
        function fn_modify_member_all_info(member_id){
            var member_pw_value;
            ...
            $.ajax({
                type : "post",
                async : false, //false인 경우 동기식으로 처리한다.
                url : "${contextPath}/admin/member/modifyMemberInfoAll.do",
                data : {
            ...
            <tr class="dot_line">
                ...
                <td>
                    ...
                    <p>
                        ...
                        나머지 주소: <input type="text"  name="detailAddress" size="50" value="${member_info.detailAddress }" />
        ...
        <table align=center>
            <tr>
                <td >
                    ...
                    <input name="btn_modify_all" type="button"  value="수정하기" onClick="fn_modify_member_all_info('${member_info.member_id }')">
                </td>
            </tr>
        </table>
    </div>
